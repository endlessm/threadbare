...
func _configurar_mini_vista() -> void:
	...
	var escena_ancho: float = 3520.0
	var escena_alto: float = 1300.0

	var zoom_x: float = 200.0 / escena_ancho
	var zoom_y: float = 150.0 / escena_alto
	var zoom_final: float = min(zoom_x, zoom_y)
