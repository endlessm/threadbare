...
var balloon_scene = preload("res://scenes/ui_elements/dialogue/balloon.tscn")
var tablero = [
	1, 2, 3,
	4, 5, 6,
	7, 8, 0
...
const RUTA_ESTADO_ACERTIJO = "user://acertijo_resuelto.save"
...
func _guardar_acertijo_resuelto() -> void:
	var archivo = FileAccess.open(RUTA_ESTADO_ACERTIJO, FileAccess.WRITE)
	if archivo:
