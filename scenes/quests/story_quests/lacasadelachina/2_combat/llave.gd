...
@export var siguiente_escena: String = "res://scenes/quests/story_quests/lacasadelachina/2_combat/lacasadelachina_combat.tscn"
...
func _on_body_entered(body):
	...
	if body is Player:
		ya_agarrada = true
		get_node("/root/LacasadelachinaStealth").llave_recogida_por_jugador()
