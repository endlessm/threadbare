...
const SPLASH: PackedScene = preload(
	"res://scenes/story_quests/main_quests/lore_quest/ink_combat/components/splash/splash.tscn"
)
const BIG_SPLASH: PackedScene = preload(
	"res://scenes/story_quests/main_quests/lore_quest/ink_combat/components/big_splash/big_splash.tscn"
)
