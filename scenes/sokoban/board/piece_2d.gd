...
@export var groups: PieceGroups: get = _get_groups, set = _set_groups
@export var layer : int

var active: bool = true
## `global_position`, rounded to snap to the grid
var grid_position: Vector2i: get = _get_grid_position, set = _set_grid_position
var _board: Board2D: set = _set_board
...
func _set_grid_position(value: Vector2i) -> void:
    if _board:
        ...
        push_warning("Piece \"%s\" is missing a board reference and couldn't set it's position!" % name)
