...
func apply_character_randomizations() -> void:
	...
	# TODO: Randomizing all at once would be better.
	# But it changes the look of existing characters.
	...
	cel_shading_recolor.set_random_hair_color(_random_number_generator)
	cel_shading_recolor.set_random_cloth_color(_random_number_generator)
